...
<head>
    ...
    <title>Undangan Pernikahan Muhtar & Najma</title>
    <meta name="title" content="Undangan Pernikahan Muhtar & Najma">
    <meta name="description" content="Website Undangan Pernikahan Muhtar & Najma Secara Online">
    <link rel="icon" type="image/png" sizes="192x192" href="./assets/images/logo_lincode.png">
...
<body data-email="user@example.com" data-password="12345678" data-url="https://lincode1902.my.id">
            ...
            <div class="text-center pt-4">
                ...
                <div class="py-4">
                    <div class="cropper border border-3 border-light shadow mx-auto">
                        <img src="assets/images/image_depan.jpg" style="height: 100%;" alt="bg" onclick="modalFoto(this)">
                    </div>
                </div>
                <h1 class="font-estetik my-4" style="font-size: 3rem;">Muhtar & Najma</h1>
                <h4>Sabtu, 08 Juli 2023</h4>
                <a class="btn btn-outline-light btn-sm shadow rounded-pill px-3 my-2" target="_blank" href="https://calendar.google.com/calendar/render?action=TEMPLATE&text=The%20Wedding%20of%20Muhtar%20and%20Najma&details=The%20Wedding%20of%20Muhtar%20and%20Najma%20%7C%2015%20Maret%202023%20%7C%20RT%2010%20RW%2002,%20Desa%20Pajerukan,%20Kec.%20Kalibagor,%20Kab.%20Banyumas,%20Jawa%20Tengah%2053191%20%7C%2010.00%20-%2011.00%20WIB&dates=20230315T100000/20230315T110000&location=https://goo.gl/maps/ALZR6FJZU3kxVwN86">
                ...
                <div class="overflow-x-hidden">
                    <div data-aos="fade-right" data-aos-duration="2000">
                        <div class="cropper border border-3 border-light shadow my-4 mx-auto">
                            <img src="assets/images/foto_cowok.jpg" alt="bg" onclick="modalFoto(this)">
                        </div>
                        <h1 class="font-estetik" style="font-size: 3rem;">Muhtar Baehaki</h1>
                        <h5 class="mt-3 mb-0">Putra</h5>
                        <p class="mb-0">Bapak Minan yuritman & Ibu Irnah Irawati Setiani</p>
                    </div>
                    ...
                    <div data-aos="fade-left" data-aos-duration="2000">
                        <div class="cropper border border-3 border-light shadow my-4 mx-auto">
                            <img src="assets/images/foto_cewek.jpg" alt="bg" onclick="modalFoto(this)">
                        </div>
                        <h1 class="font-estetik" style="font-size: 3rem;">Najma Laila</h1>
                        <h5 class="mt-3 mb-0">Putri</h5>
                        <p class="mb-0">Bapak Romlih S.Ag & Ibu Munawaroh</p>
                    </div>
                </div>
            </div>
        </section>
            ...
            <div class="container">
                <div class="text-center">
                    ...
                    <div class="border rounded-pill shadow py-2 px-4 mx-2 mb-4">
                        <div class="row justify-content-center" data-waktu="2023-07-08 09:00:00" id="tampilan-waktu">
                            <div class="col-3 p-1">
                    ...
                    <div class="py-2" data-aos="fade-up" data-aos-duration="1500">
                        <a href="https://maps.app.goo.gl/8Vb8rvaZrpsnCZww9" target="_blank" class="btn btn-outline-light btn-sm rounded-pill shadow-sm mb-2 px-3">
                            <i class="fa-solid fa-map-location-dot me-2"></i>Lihat Google Maps
                        </a>
                        <p class="mb-0 mt-1 mx-1 pb-4" style="font-size: 0.9rem;">
                            Mekarjaya RT 007 RW 003 desa batujaya kecamatan batujaya kabupaten karawang 41354
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="container pb-2 pt-4">
                <div class="card-body border rounded-4 shadow p-3">
                    ...
                    <div id="carouselExampleIndicators" data-aos="fade-up" data-aos-duration="1500" class="carousel slide" data-bs-ride="carousel">
                        ...
                        <div class="carousel-inner rounded-4">
                            <div class="carousel-item active">
                                <img src="assets/images/galery1.jpg" class="d-block w-100" style="height: 500px;" onclick="modalFoto(this)">
                            </div>
                            <div class="carousel-item">
                                <img src="assets/images/galery2.jpg" class="d-block w-100" style="height: 500px;" onclick="modalFoto(this)">
                            </div>
                            <div class="carousel-item">
                                <img src="assets/images/galery3.jpg" class="d-block w-100" style="height: 500px;" onclick="modalFoto(this)">
                            </div>
                        </div>
                    ...
                    <div id="carousel2" data-aos="fade-up" data-aos-duration="1500" class="carousel slide mt-4" data-bs-ride="carousel">
                        ...
                        <div class="carousel-inner rounded-4">
                            <div class="carousel-item active">
                                <img src="assets/images/galery4.jpg" class="d-block w-100" style="height: 500px;" onclick="modalFoto(this)">
                            </div>
                            <div class="carousel-item">
                                <img src="assets/images/galery5.jpg" class="d-block w-100" style="height: 500px;" onclick="modalFoto(this)">
                            </div>
                            <div class="carousel-item">
                                <img src="assets/images/image_depan.jpg" class="d-block w-100" style="height: 500px;" onclick="modalFoto(this)">
                            </div>
                        </div>
                    ...
                    <div class="overflow-x-hidden">
                        <div class="row justify-content-center">
                            <div class="col-12 card-body border rounded-4 shadow p-3 m-3" style="max-width: 25rem;" data-aos="fade-down" data-aos-duration="1500">
                                <img src="assets/images/dana.png" class="img-fluid rounded" width="150" alt="bni">
                                ...
                                <button class="btn btn-light btn-sm rounded-4" data-nomer="+6285890456759" onclick="salin(this)" autofocus>Salin No. Dana</button>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row align-items-center justify-content-between flex-column flex-sm-row">
                        <div class="col-auto">
                            <small class="text-light">
                                Build with<i class="fa-solid fa-heart mx-1"></i>Ilham
                            </small>
                        </div>
                        <div class="col-auto">
                            <small>
                                <i class="fa-brands fa-github me-1"></i><a target="_blank" href="#">Ilham</a>
                            </small>
                        </div>
                    </div>
                </div>
            ...
            <div class="modal-content m-0 p-0">
                <div class="d-flex justify-content-center align-items-center" style="height: 100vh !important;">
                    <div class="text-center">
                        ...
                        <h1 class="font-estetik my-4" style="font-size: 2.5rem;">Muhtar & Najma</h1>
                        <div class="cropper border border-3 border-light shadow mb-4 mx-auto">
                            <img src="assets/images/image_depan.jpg" style="height: 100%;" alt="bg">
                        </div>
                        <p>Kepada Yth:</p>
                        <h5 class="font-estetik my-4" style="font-size: 2.5rem;">
                            <?php

                            $data_nama = $_GET['nama'];
                            $nama = str_replace("_", " ", $data_nama);
                            echo  $nama;
